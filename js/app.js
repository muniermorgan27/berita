$(document).ready(function () {
  ...
  let url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=692d47a28ed54213bf94e1ddb852f76a";
        ...
        output += `
          ...
          <div class="card medium hoverable">
            ...
            <div class="card-action">
              <a href="https://breezyanne.blogspot.com/2021/03/?u-${latestNews[i].url}" target="_blank" class="btn">Read More</a>
            </div>
           </div>
          </div>
        `;
